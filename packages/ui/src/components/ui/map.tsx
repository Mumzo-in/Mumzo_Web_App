...
// biome-ignore lint/suspicious/noShadowRestrictedNames: <its ok>
...
function MapRoute({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [isLoaded, map, color, opacity, dashArray, layerId, width, sourceId]);
...
>({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [isLoaded, map, data, lineLayerId, fillLayerId, sourceId, promoteId]);
