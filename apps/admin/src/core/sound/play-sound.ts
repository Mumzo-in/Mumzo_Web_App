...
/**
 * Plays a `public/` audio file, fire-and-forget. Swallows the rejection
 * browsers throw when autoplay is blocked (no prior user gesture on the
 * page yet) — that's an expected, common state, not a bug to surface.
 *
